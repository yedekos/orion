...
const GridBody = ({ table }) => {
  // Get current theme mode from settings
  const { settings } = useSettings()
  const mode = settings.mode

  // Define colors explicitly to ensure they apply correctly
  const lightBgColor = ['#ffffff', '#f0f0f0'] // Light mode colors
  const darkBgColor = ['#374151', '#1f2937'] // Dark mode colors
